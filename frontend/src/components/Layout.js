...
const SIDEBAR_NAV = [
  ...
  { name: "Policy Builder", href: "/policies", icon: FileText },
  { name: "Document Analysis", href: "/documents", icon: CloudArrowUp },
  { name: "Policy Library", href: "/policy-library", icon: Files },
  { name: "AI Mappings", href: "/mappings", icon: GitBranch },
  { name: "Cross-Framework", href: "/cross-framework", icon: FlowArrow },
