...
CONTROL_MAPPINGS = {
    "authentication": {
        "controls": [
            ...
            "CIP-004-R4", "CIP-005-R1", "CIP-005-R2", "CIP-007-R5",
            "Art.32",
        ],
    ...
    "authorization": {
        "controls": [
            ...
            "CIP-006-R1", "CIP-006-R2", "CIP-011-R1",
            "Art.25",
        ],
        "frameworks": ["nist-800-53", "nist-csf", "nist-800-171", "iso-27001", "hipaa", "soc2", "cmmc", "nis2", "stateramp", "gdpr"],
    ...
    "risk_management": {
        "controls": [
            ...
            "CIP-010-R3", "CIP-013-R1", "CIP-014-R1", "IRO-001", "IRO-002", "TPL-001",
            "Art.35",
        ],
        "frameworks": ["nist-800-53", "nist-csf", "nist-800-171", "iso-27001", "hipaa", "soc2", "cmmc", "nis2", "stateramp", "gdpr"],
    ...
    "incident": {
        "controls": [
            ...
            "CIP-008-R1", "CIP-008-R2", "CIP-008-R3", "EOP-004", "EOP-008",
            "Art.33", "Art.34",
        ],
        "frameworks": ["nist-800-53", "nist-csf", "nist-800-171", "iso-27001", "hipaa", "soc2", "cmmc", "nis2", "stateramp", "gdpr"],
    ...
    "system": {
        "controls": [
            ...
            "CIP-003-R1", "CIP-007-R1", "CIP-007-R2", "CIP-007-R3", "CIP-009-R1", "CIP-012-R1",
            "COM-001", "TOP-001", "TOP-010", "BAL-001", "PRC-005",
            "Art.32",
        ],
        "frameworks": ["nist-800-53", "nist-csf", "nist-800-171", "iso-27001", "hipaa", "soc2", "cmmc", "nis2", "stateramp", "gdpr"],
